...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ru.mirea.prokhorovad.mireaproject.databinding.ActivityMainBinding binding = ActivityMainBinding.inflate(getLayoutInflater());
        ...
        marker.setPosition(new GeoPoint(55.61169, 37.68615));
        marker.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Музей-заповедник Царицыно\nДольская ул., 1",
        ...
        marker2.setPosition(new GeoPoint(55.83097, 37.62983));
        marker2.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Выставка достижений народного хозяйства\nпр-т Мира, 119",
                        Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        ...
        marker3.setPosition(new GeoPoint(55.76015, 37.61882));
        marker3.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Большой театр, Театральная пл., 1, Москва",
